...
function getLocale() {
	// this was a bit more complicated back in the day...
	return Randomizer.overrideServers.db.tables.locales.global["en"];
}

function itemToName(id) {
	let tpl = getLocale().templates[id]
	return (tpl && tpl.Name) || "[no item found]";
}
function itemToDesc(id) {
	let tpl = getLocale().templates[id]
	return (tpl && tpl.Description) || "[description: no item found]";
}

function catToName(id) {
	return getLocale().handbook[id];
}

module.exports.itemToName = itemToName;
module.exports.itemToDesc = itemToDesc;
module.exports.catToName = catToName;
module.exports.getLocale = getLocale;

global.rand_fastlocale = module.exports
